from dafne.data.datasets.icdar15 import load_annotation, parse_annotation
...
class Icdar15Evaluator(DafneEvaluator):
...
"""
    ...
    detpath is the path for 15 result files, for the format, you can refer to "http://captain.whu.edu.cn/ICDARAODweb/tasks.html"
