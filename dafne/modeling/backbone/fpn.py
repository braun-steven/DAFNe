from detectron2.modeling.backbone.resnet import BasicStem, DeformBottleneckBlock, ResNet
...
class LastLevelP6P7(nn.Module):
    """
    This module is used in RetinaNet and DAFNE to generate extra layers, P6 and P7 from
    C5 or P5 feature.
    """
...
class LastLevelP6(nn.Module):
    """
    This module is used in DAFNe to generate extra layers
    """
